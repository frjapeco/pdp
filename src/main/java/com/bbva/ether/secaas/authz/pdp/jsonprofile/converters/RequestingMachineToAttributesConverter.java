...
import com.bbva.ether.secaas.authz.pdp.jsonprofile.model.RequestingMachine;
...
@Component
public class RequestingMachineToAttributesConverter extends CustomConverter<RequestingMachine, Attributes> {

    @Autowired
    private OrikaBeanMapper mapper;

    public Attributes convert(RequestingMachine source, Type<? extends Attributes> destinationType, MappingContext ctx) {
