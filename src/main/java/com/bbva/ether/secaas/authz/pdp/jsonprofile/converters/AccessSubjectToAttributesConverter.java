...
import com.bbva.ether.secaas.authz.pdp.jsonprofile.model.AccessSubject;
...
@Component
public class AccessSubjectToAttributesConverter extends CustomConverter<AccessSubject, Attributes> {

    @Autowired
    private OrikaBeanMapper mapper;

    public Attributes convert(AccessSubject source, Type<? extends Attributes> destinationType, MappingContext ctx) {
