...
@Component
public class CategoryToAttributesConverter extends CustomConverter<Category, Attributes> {

    @Autowired
    private OrikaBeanMapper mapper;

    public Attributes convert(Category source, Type<? extends Attributes> destinationType, MappingContext ctx) {
