...
import com.bbva.ether.secaas.authz.pdp.jsonprofile.model.Resource;
...
@Component
public class ResourceToAttributesConverter extends CustomConverter<Resource, Attributes> {

    @Autowired
    private OrikaBeanMapper mapper;

    public Attributes convert(Resource source, Type<? extends Attributes> destinationType, MappingContext ctx) {
