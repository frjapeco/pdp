...
import com.bbva.ether.secaas.authz.pdp.jsonprofile.model.CodeBase;
...
@Component
public class CodeBaseToAttributesConverter extends CustomConverter<CodeBase, Attributes> {

    @Autowired
    private OrikaBeanMapper mapper;

    public Attributes convert(CodeBase source, Type<? extends Attributes> destinationType, MappingContext ctx) {
