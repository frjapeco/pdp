...
import com.bbva.ether.secaas.authz.pdp.jsonprofile.model.Action;
...
@Component
public class ActionToAttributesConverter extends CustomConverter<Action, Attributes> {

    @Autowired
    private OrikaBeanMapper mapper;

    public Attributes convert(Action source, Type<? extends Attributes> destinationType, MappingContext ctx) {
