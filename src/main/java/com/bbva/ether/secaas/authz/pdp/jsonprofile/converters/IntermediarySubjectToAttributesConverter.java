...
import com.bbva.ether.secaas.authz.pdp.jsonprofile.model.IntermediarySubject;
...
@Component
public class IntermediarySubjectToAttributesConverter extends CustomConverter<IntermediarySubject, Attributes> {

    @Autowired
    private OrikaBeanMapper mapper;

    public Attributes convert(IntermediarySubject source, Type<? extends Attributes> destinationType, MappingContext ctx) {
